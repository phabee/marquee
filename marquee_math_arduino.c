...
{0, 0, 65, 127, 127, 65, 0, 0}, // I
{0, 1, 63, 127, 65, 96, 32, 0}, // J
{0, 65, 99, 54, 28, 127, 127, 0}, // K
{0, 64, 64, 64, 64, 127, 127, 0}, // L
{127, 127, 6, 12, 6, 127, 127,0}, // M
{0, 127, 127, 28, 14, 127, 127, 0}, // N
{0, 62, 127, 65, 65, 127, 62, 0}, // O
{0, 6, 15, 9, 9, 127, 127, 0}, // P
{0, 94, 127, 97, 33, 63, 30, 0}, // Q
{0, 70, 111, 57, 25, 127, 127, 0}, // R
{0, 50, 123, 73, 73, 111, 38, 0}, // S
{0, 1, 1, 127, 127, 1, 1, 0}, // T
{0, 63, 127, 64, 64, 127, 63, 0}, // U
{0, 31, 63, 96, 96, 63, 31, 0}, // V
{127, 127, 48, 24, 48, 127, 127, 0}, // W
{0, 99, 119, 28, 28, 119, 99, 0}, // X
{0, 7, 15, 120, 120, 15, 7, 0}, // Y
{0, 67, 71, 77, 89, 113, 97, 0}, // Z
...
char msgTxt[100];
char tmpStr[12];
uint8_t msgCode[100] = {0};
int msgLen;

void encodeMessage(char *string, int strLen, uint8_t *codeArr);
void generateCalculationTask(char* msgTxt);
...
void loop() {
    ...
    generateCalculationTask(msgTxt, tmpStr);
...
void generateCalculationTask(char* msgTxt, char* tmpStr) {
  int a = rand() % 20 + 1;
  int b = rand() % 20 + 1;
  int c = a + b;
